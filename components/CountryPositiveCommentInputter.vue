<template>
  <div class="comment-input-section">
    ...
    <button class="positive-comment-button" v-show="!showModalPositive" @click="showModalPositive = true" > {{ $t('CountryPCS.InputterButtonMessage')}} </button>
    ...
    <div class="buttons">
      <button class="small-buttons" v-show="showModalPositive && this.$store.state.user.userUID" @click="submitPositiveComment(), (showModalPositive = false)" type="submit" > {{ $t('CountryPCS.InputterSubmitButton')}} </button>
      <button class="small-buttons" v-show="showModalPositive && this.$store.state.user.userUID" @click="showModalPositive = false" > {{ $t('CountryPCS.InputterCloseButton')}} </button>
    </div>
  </div>
</template>
