...
export default {
  ...
  global: {
    fieldset: 'max-w-lg border border-gray-400 rounded px-2 pb-1',
  ...
  'family:text': {
    inner:
      'flex items-center max-w-lg ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
    input:
  ...
  textarea: {
    inner:
      'flex max-w-lg rounded mb-1 ring-1 ring-gray-400 focus-within:ring-blue-500 [&>label:first-child]:focus-within:text-blue-500',
    input:
